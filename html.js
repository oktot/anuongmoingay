...
module.exports = React.createClass({
  ...
  render() {
    ...
    return (
      <html lang="en">
        <head>
		  ...
		  <meta name="google-site-verification" content="boAVTMCojVyDF_c79hYZnP5gb7AeglWQbRY3gN9NsDc" />
	...
	<div id="react-mount" style={{width:'100%'}} dangerouslySetInnerHTML={ {    __html: this.props.body} } />
		  ...
		  <script async src='https://www.googletagmanager.com/gtag/js?id=UA-121181764-1' />
...
function buildGoogleAdSense() {
  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: 'ca-pub-8288882953812927',
